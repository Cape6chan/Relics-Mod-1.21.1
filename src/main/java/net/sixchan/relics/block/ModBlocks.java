package net.sixchan.relics.block;
...
import net.sixchan.relics.block.custom.MagicBlock;
...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, Identifier.of(Relics.MOD_ID, name), block);
    }

    private static void registerBlockItem(String name, Block block) {
        Registry.register(Registries.ITEM, Identifier.of(Relics.MOD_ID, name),
                new BlockItem(block, new Item.Settings()));
    }

    public static void registerModBlocks() {
        Relics.LOGGER.info("Registering Mod Blocks for " + Relics.MOD_ID);
